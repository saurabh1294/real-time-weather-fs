# real-time-weather-api-host
Small demo app using angular 6 to fetch and manipulate Weather data for a given location/address


# Angular real-time-weather-api demo App
...
cd real-time-weather-api and then run npm install
